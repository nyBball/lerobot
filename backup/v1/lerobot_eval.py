...
def eval_main(cfg: EvalPipelineConfig):
    ...
    from lerobot.policies.pi05.processor_pi05 import Pi05PreserveNormalizedStateProcessorStep
    # # 在 normalizer_processor 之后插入 (index=3)
    preprocessor.steps.insert(3, Pi05PreserveNormalizedStateProcessorStep())
