...
def train(cfg: TrainPipelineConfig, accelerator: Accelerator | None = None):
    ...
    image_feature_keys = [k for k in policy.config.input_features.keys() if "image" in k.lower()]
    from lerobot.policies.pi05.processor_pi05 import Pi05QueueFillingAugmentationStep
    preprocessor.steps.insert(2, Pi05QueueFillingAugmentationStep(
            aug_prob=cfg.policy.queue_filling_aug_prob,
